...
export const assistProduct = {
  ...
  detailsHref: 'https://www.latamairlines.com/py/es/experiencia-de-viaje/asistencia-en-viaje',
  termsHref: 'https://www.latamairlines.com/py/es/legal/terminos-y-condiciones',
  specialAssistHref: 'https://www.latamairlines.com/py/es/experiencia-latam/asistencia-especial',
  benefits: [
    {
